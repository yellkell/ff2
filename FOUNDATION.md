...
- **1V1 QUICK MATCH** — competitive online duels through the bundled relay
  server. **Best of 3** rounds, 60 s each, knockout or higher health at the
  bell — the drop-in queue runs short. RANKED rooms and private-code matches
  keep the longer **best of 5**.
