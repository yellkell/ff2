 ...
 * files), ported whole from RAVE RAID. One family, three weights,
 * everywhere text is painted onto a kit panel: 700 carries headlines and
 * CTAs, 600 carries interactive labels, 500 carries reading text. Weight
 * does the hierarchy work that nine hundred blackface used to shout over.
 *
